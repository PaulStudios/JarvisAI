...
def error(code, severity=0, errortype=""):
    ...
    console.log(m_name + "Error has been detected. Investigating...",
                style="bright_red")
    # skipcq: PYL-W0612
    for i in track(
            range(30),
    ...
    if severity > 0:
        if errortype == "auth":
            LOGGER.critical("Authentication error detected. Error code : %s",
                            code)
            console.log(m_name +
            ...
            console.log(m_name + "Connection error detected. Error code : ",
                        code,
                        style="bright_red")
        else:
            LOGGER.critical("Program error detected. Error code : %s", code)
            console.log(m_name + "Program error detected. Error code : ",
                        code,
                        style="bright_red")
        sys.exit(0)
